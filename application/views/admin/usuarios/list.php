                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url(); ?>administrador/usuarios/add"
                            class="btn btn-primary btn-flat"><span class="fa fa-plus">Agregar Usuario</span></a>
                    </div>
                </div>
                <hr>
                <!-- Buscador -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="<?php echo base_url() ?>mantenimiento/usuarios/edit/<?php echo $usuario->id; ?>"
                                                        class="btn btn-warning"><span class="fa fa-pencil"></span></a>
                                                    <a href="<?php echo base_url(); ?>mantenimiento/usuarios/delete/<?php echo $usuario->id;?>" 
